...
private:
	math::vec2 ppi_{glyph_size::screen_ppi};
	//TODO make the default size deduced by ppi?
	// glyph_size_type default_size{font_size::get_glyph_std_size_at(font_size::standard_size).round<glyph_size_type::value_type>().max({1, 1})};
